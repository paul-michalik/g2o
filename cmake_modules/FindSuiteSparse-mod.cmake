FIND_PATH(CHOLMOD_INCLUDE_DIR NAMES cholmod.h amd.h camd.h
    ...
    /sw/include/ufsparse
    ${SUITE_SPARSE_ROOT}/include/suitesparse
  )
...
FIND_LIBRARY(AMD_LIBRARY NAMES SHARED NAMES amd libamd
  PATHS
  ${SUITE_SPARSE_ROOT}/lib
  /usr/lib
  /usr/local/lib
...
FIND_LIBRARY(CAMD_LIBRARY NAMES camd libcamd
  PATHS
  ${SUITE_SPARSE_ROOT}/lib
  /usr/lib
  /usr/local/lib
